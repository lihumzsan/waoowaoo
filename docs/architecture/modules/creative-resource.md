...
| 用户上传素材 Resource 与 Revision | `api_project_upload_media` 同步物化（经 persistence 唯一入口） | `imageReferences`/`mediaReferences`/音色绑定、Resource View、Canvas |
