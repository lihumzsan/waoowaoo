...
- **CP-06 — 最小上下文纯派生。** Context Compiler 只从显式 canonical screenplay/Story Canon/Chapter/Style/asset revisionId 为一个 Chapter 构造有界输入；缺失、scope 或 schema 不符必须失败。它不写事实、不选择 Skill、不创建 Task、不决定执行顺序。
