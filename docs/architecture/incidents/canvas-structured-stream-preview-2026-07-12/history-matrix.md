...
| Final Golden mainline | Prove empty project reaches durable final video | Immediate one-chunk local model plus terminal-only oracle missed processing-time UI divergence | `GJ-CANVAS-STRUCTURED-PREVIEW` paces real provider chunks and asserts the processing-time card before terminal |
