...
criticalLocalizedTemplateTokens.set('project-agent/system', {
  en: [
    ...
    'That Revision is the screenplay; there is no second formal copy or confirmed-screenplay state.',
  ...
  zh: [
    ...
    'Resource Revision 就是剧本，不需要“正式剧本”副本或确认状态。',
