...
export const ERROR_CATALOG = {
  ...
  UPLOAD_AUDIO_DURATION_INVALID: defineErrorSpec('UPLOAD_AUDIO_DURATION_INVALID', 400, false, ERROR_CATEGORY.VALIDATION, 'Uploaded audio duration could not be read'),
