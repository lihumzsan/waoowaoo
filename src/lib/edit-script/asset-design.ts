...
export function buildEditAssetDesignInstruction(input: BuildEditAssetDesignInstructionInput): string {
  return JSON.stringify({
    ...
    constraints: [
      ...
      'Use styleBible.visualStyle together with styleBible.assetImageStyle as the only asset-image visual policy.',
      'The asset description must apply the shared visual style plus asset-only lighting, texture, and composition rules.',
