...
export const storyCanonCharacterVoiceProfileSchema = z.string()
  .trim()
  .min(1)
  .max(48)
...
export type StoryCanonCharacterVoiceProfile = z.infer<typeof storyCanonCharacterVoiceProfileSchema>
