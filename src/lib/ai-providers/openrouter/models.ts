...
export const OPENROUTER_BUILTIN_CAPABILITY_CATALOG_ENTRIES = [
  ...
  { modelType: 'llm', provider: 'openrouter', modelId: OPENROUTER_GEMINI_3_5_FLASH_MODEL_ID, capabilities: { llm: { reasoningEffortOptions: ['minimal', 'low', 'medium', 'high'] } } },
  ...
  { modelType: 'llm', provider: 'openrouter', modelId: OPENROUTER_GPT_5_6_LUNA_MODEL_ID, capabilities: { llm: { reasoningEffortOptions: [...OPENROUTER_GPT_5_6_REASONING_EFFORT_OPTIONS] } } },
  { modelType: 'llm', provider: 'openrouter', modelId: OPENROUTER_GPT_5_6_TERRA_MODEL_ID, capabilities: { llm: { reasoningEffortOptions: [...OPENROUTER_GPT_5_6_REASONING_EFFORT_OPTIONS] } } },
  { modelType: 'llm', provider: 'openrouter', modelId: OPENROUTER_GPT_5_6_SOL_MODEL_ID, capabilities: { llm: { reasoningEffortOptions: [...OPENROUTER_GPT_5_6_REASONING_EFFORT_OPTIONS] } } },
  {
    modelType: 'video',
    provider: 'openrouter',
    modelId: OPENROUTER_SEEDANCE_2_VIDEO_MODEL_ID,
