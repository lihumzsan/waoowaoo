...
export const OPENROUTER_PLATFORM_DEFAULT_ASSISTANT_MODEL_KEY = `openrouter::${OPENROUTER_GPT_5_6_TERRA_MODEL_ID}`
export const OPENROUTER_PLATFORM_DEFAULT_IMAGE_MODEL_KEY = `openrouter::${OPENROUTER_BANANA_2_IMAGE_MODEL_ID}`
