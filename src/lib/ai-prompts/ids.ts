export const AI_PROMPT_IDS = {
  ...
  EDIT_SCRIPT_DIRECTOR_DECOUPAGE: 'director-decoupage',
  EDIT_SCRIPT_STRUCTURE: 'structure',
  EDIT_SCRIPT_ASSET_EXTRACT: 'asset-extract',
  EDIT_SCRIPT_VIDEO_PROMPT_BLOCK: 'video-prompt-block',
  EDIT_SCRIPT_VIDEO_BLOCK_ARRANGEMENT: 'video-block-arrangement',
  EDIT_SCRIPT_VIDEO_BLOCK_MERGE: 'video-block-merge',
  EDIT_SCRIPT_STORYBOARD_PANEL: 'storyboard-panel',
  EDIT_SCRIPT_CINEMATOGRAPHY_SHOT_PLAN: 'cinematography-shot-plan',
