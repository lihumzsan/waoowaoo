...
- The sound-relationship judgment is required, but a special cue is not. Add a time range and source Shot to the sound timeline of the same generated Segment only when a lead, carry, or offscreen reveal has narrative value; otherwise omit it. Keep shot-level `synchronousSound` for sound belonging to the current image.
...
> 15 seconds, 2.39:1, poetic science-fiction cinema in desaturated deep blue and silver-grey, humid air and physically believable volumetric light. Preserve the face, silver protective suit, and cylindrical hand light of the female explorer in image 1. 0–6s, in the abandoned undersea-station corridor from image 2, a stable medium view follows her forward. Her beam moves over corroded walls and suspended mist; she stops beside an unlit hatch and turns slightly to listen, <boots through shallow water, distant metal drone, controlled breathing>. 6–8s, she opens the hatch and enters a space with no illumination. The hand light physically disappears and the corridor reaches near-black because its in-scene light is gone while the metal drone continues; change cleanly only after the image is dark, with no fade-out. 8–12s, the first frame of the new shot is already the storm sea from image 3, fully established but naturally near-black. A lighthouse beam sweeps across and illuminates the sea and lighthouse that were already present. Match its direction and speed to the earlier hand light as a clear visual metaphor, but never show both locations at once or blend them transparently, <the metal drone naturally becomes ocean wind and deep surf>. 12–15s, the distant camera slowly pulls back; the lighthouse looks small against giant waves, and its beam crosses again to reveal an enormous motionless silhouette inside the clouds, <one remote low-frequency call>. Use this transition only once between 6–8s and 8–12s. The explorer appears only in the undersea station; do not duplicate her in the lighthouse shot. Preserve clear sound, beam direction, and emotional escalation. No captions or extra objects. No dissolves, cross-dissolves, fade-ins, or fade-outs between shots; outgoing and incoming images must never overlap transparently.

### Example four: this version's complete audiovisual prompt

> 15 seconds, 2.39:1, grounded suspense cinema at an abandoned mountain station during a rainstorm, desaturated blue-grey with localized warm tungsten station light and physically credible rain mist and materials. Preserve the face, soaked dark uniform, brass pocket watch, and low rough intrinsic voice of the elderly stationmaster in image 1. Keep the location entirely within the platform, canopy, and tracks from image 2; do not invent a second station. 0–4s, close-up of the red signal lamp and rain-darkened rails, with no face or mouth visible. First hear the stationmaster offscreen speak the exact line once: {Do not turn around. That is not the last train.} <heavy rain on the iron canopy, light rattle of the signal chain>; one distant station bell begins at 3s. 4–9s, a medium view tracks sideways beneath the canopy and reveals the stationmaster behind a column, gripping the pocket watch. The line has ended; his mouth remains closed as he looks past the camera toward the end of the tracks. The bell carries across the Shot boundary and is gradually covered by a low rail vibration, <wet shoe shift, water dripping from the uniform, continuing station bell, deepening rail resonance>. 9–15s, cut to a long-lens view down the tracks. A cold white headlight approaches through the rain, but the train body never enters frame before the end. The stationmaster's hand and watch remain at the foreground edge; the second hand stops, and in the final second the bell cuts out, leaving only rain and one metallic stress sound. The sound relationships are layered and explicit: offscreen dialogue leads the character reveal, the station bell carries across Shots, and each Shot's synchronized sound follows visible action. Do not repeat dialogue, add narration, generate BGM, captions, text, extra people, or an unmotivated scream. Preserve character identity, rain direction, lighting, and space throughout.
