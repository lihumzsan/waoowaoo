...
- Within one generated Segment, when sound leads its visual source, carries across a shot boundary, or reveals a character through offscreen dialogue, an optional Segment-level sound timeline may state its time range and source shot. This is a directing option, not a requirement; omit it when it adds no value. Keep shot-level `synchronousSound` for sound that belongs to the current image.
...
### Example four: sound leads the reveal of a character

> 12 seconds, 16:9, restrained grounded café drama, soft overcast window light, shallow focus with clear spatial relationships. Preserve the coffee cup, wooden table, and window-side café from image 1, and preserve the face, dark knit sweater, and low intrinsic voice of the woman in image 2. 0–4s, close-up of the coffee cup and steam; do not show a face or mouth. First, hear the woman offscreen say the exact line: {Are you really leaving?} The complete line plays while the cup remains the image, <ceramic set down gently, distant café voices, low room air>. 4–8s, slowly pull back from the cup, first revealing her hand pressing against the table, then the side of her face. She has already finished the line and waits for an answer; do not repeat the line or create a mismatched lip movement. 8–12s, settle into a medium close view of her and the empty chair across the table. Her gaze stays offscreen while the steam and café ambience continue naturally. The sound lead is the single directing emphasis of this Segment, serving suspense and character reveal; it is optional and should not be applied to every dialogue scene. No narration, captions, or extra people.
