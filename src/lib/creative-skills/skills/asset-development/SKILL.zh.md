...
本 Skill 负责角色、场景、道具、参考图、候选资产和已有资产修改的视觉设计方法。项目级呈现政策与方向候选由 `creative-direction` Skill 负责。输出长度、候选数量、JSON 格式、图片画幅、资产板精确版式、provider 参数、真实人物安全策略和最终图片提示词后缀由调用方与执行层定义。
