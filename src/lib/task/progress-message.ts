...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.AUDIO_DESIGN_PLAN]: 'progress.taskType.audioDesignPlan',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  audio_design_prepare: 'progress.stage.audioDesignPrepare',
  audio_design_plan: 'progress.stage.audioDesignPlan',
  audio_design_plan_persisted: 'progress.stage.audioDesignPlanPersisted',
