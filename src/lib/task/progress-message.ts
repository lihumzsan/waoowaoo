...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.MUSIC_SCORE_PLAN]: 'progress.taskType.musicScorePlan',
  [TASK_TYPE.MUSIC_SCORE_GENERATE]: 'progress.taskType.musicScoreGenerate',
  [TASK_TYPE.AMBIENT_SOUND_PLAN]: 'progress.taskType.ambientSoundPlan',
  [TASK_TYPE.AMBIENT_SOUND_GENERATE]: 'progress.taskType.ambientSoundGenerate',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  bgm_score_plan_persisted: 'progress.stage.bgmScorePlanPersisted',
  bgm_score_generate_music: 'progress.stage.bgmScoreGenerateMusic',
  bgm_score_persist: 'progress.stage.bgmScorePersist',
  ambient_sound_prepare: 'progress.stage.ambientSoundPrepare',
  ambient_sound_plan: 'progress.stage.ambientSoundPlan',
  ambient_sound_plan_persisted: 'progress.stage.ambientSoundPlanPersisted',
  ambient_sound_generate_sources: 'progress.stage.ambientSoundGenerateSources',
  ambient_sound_mix: 'progress.stage.ambientSoundMix',
  ambient_sound_persist: 'progress.stage.ambientSoundPersist',
