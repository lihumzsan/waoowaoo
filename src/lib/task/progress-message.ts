...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.CONTINUITY_EXPERIMENT_IMAGE]: 'progress.taskType.continuityExperimentImage',
  [TASK_TYPE.MUSIC_GENERATE]: 'progress.taskType.musicGenerate',
  [TASK_TYPE.MUSIC_SCORE_PLAN]: 'progress.taskType.musicScorePlan',
  [TASK_TYPE.SOUNDSCAPE_PLAN]: 'progress.taskType.soundscapePlan',
  [TASK_TYPE.SOUNDSCAPE_GENERATE]: 'progress.taskType.soundscapeGenerate',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  continuity_experiment_prepare: 'progress.stage.continuityExperimentPrepare',
  continuity_experiment_generate: 'progress.stage.continuityExperimentGenerate',
  continuity_experiment_complete: 'progress.stage.continuityExperimentComplete',
  ...
  music_score_plan_generate_music: 'progress.stage.musicScorePlanGenerateMusic',
