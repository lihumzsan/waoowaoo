...
const TASK_INTENT_BY_TYPE: Record<TaskType, TaskIntent> = {
  ...
  [TASK_TYPE.IMAGE_EPISODE_COVER]: 'generate',
  [TASK_TYPE.IMAGE_CHARACTER]: 'generate',
  [TASK_TYPE.IMAGE_LOCATION]: 'generate',
  [TASK_TYPE.VIDEO_PANEL]: 'generate',
  [TASK_TYPE.VIDEO_SEAM_CONCAT]: 'process',
  [TASK_TYPE.ENVIRONMENT_SOUND_ANALYZE]: 'analyze',
  [TASK_TYPE.ENVIRONMENT_SOUND_GENERATE]: 'generate',
  [TASK_TYPE.ENVIRONMENT_SOUND_CLEANUP]: 'process',
  [TASK_TYPE.LIP_SYNC]: 'process',
  [TASK_TYPE.VOICE_LINE]: 'generate',
  [TASK_TYPE.FREE_VOICE]: 'generate',
  ...
  [TASK_TYPE.GENERATE_FIRST_LAST_FRAME_PROMPT]: 'generate',
}
