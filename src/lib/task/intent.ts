...
const TASK_INTENT_BY_TYPE: Record<TaskType, TaskIntent> = {
  ...
  [TASK_TYPE.EDIT_STYLE_PREVIEWS_GENERATE]: 'generate',
  [TASK_TYPE.EDIT_STYLE_PREVIEW_IMAGE]: 'generate',
  [TASK_TYPE.EDIT_SCRIPT_STORYBOARD_PREPARE]: 'generate',
  ...
  [TASK_TYPE.BGM_SCORE_GENERATE]: 'generate',
  ...
  [TASK_TYPE.EDIT_SCREENPLAY_GENERATE]: 'generate',
  [TASK_TYPE.EDIT_SCREENPLAY_REVISE]: 'modify',
  [TASK_TYPE.EDIT_DIRECTOR_DECOUPAGE_GENERATE]: 'generate',
  [TASK_TYPE.EDIT_SCRIPT_GENERATE]: 'generate',
  [TASK_TYPE.EDIT_CINEMATOGRAPHY_SHOT_PLAN_GENERATE]: 'generate',
