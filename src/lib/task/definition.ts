...
export type MusicTaskHandlerKey = 'music_generate' | 'music_score_generate'
...
export const TASK_DEFINITIONS = {
  ...
  [TASK_TYPE.BGM_DESIGN_PLAN]: definition('text', 'bgm_design_plan', 'text', 3, 'episode', 'bgm_design', 'bgm_design', 'none'),
