...
export const TASK_TYPE = {
  ...
  IMAGE_EPISODE_COVER: 'image_episode_cover',
  IMAGE_CHARACTER: 'image_character',
  IMAGE_LOCATION: 'image_location',
  VIDEO_PANEL: 'video_panel',
  VIDEO_SEAM_CONCAT: 'video_seam_concat',
  ENVIRONMENT_SOUND_ANALYZE: 'environment_sound_analyze',
  ENVIRONMENT_SOUND_GENERATE: 'environment_sound_generate',
  ENVIRONMENT_SOUND_CLEANUP: 'environment_sound_cleanup',
  LIP_SYNC: 'lip_sync',
  ...
  GENERATE_FIRST_LAST_FRAME_PROMPT: 'generate_first_last_frame_prompt',
} as const
