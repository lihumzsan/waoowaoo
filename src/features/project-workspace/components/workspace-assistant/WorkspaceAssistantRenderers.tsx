...
export function ConfirmationActionCard(props: {
  ...
  const t = useTranslations('assistantAgent')
  return (
    <div className="rounded-2xl border border-[var(--glass-stroke-base)] bg-white/95 p-3 text-xs text-[var(--glass-text-secondary)] shadow-[0_6px_18px_rgba(15,23,42,0.045)] backdrop-blur-xl">
...
export function WorkspaceAssistantActiveRunCard(props: {
  ...
  return (
    <div className="order-last rounded-2xl border border-[var(--glass-stroke-base)] bg-white/95 p-3 text-xs text-[var(--glass-text-secondary)] shadow-[0_6px_18px_rgba(15,23,42,0.045)] backdrop-blur-xl">
...
export function EditStylePreviewGenerationDataCard(props: DataMessagePartProps<EditStylePreviewGenerationPartData> & {
  ...
  return (
    <div className="rounded-2xl border border-[var(--glass-stroke-base)] bg-white/95 p-3 text-xs text-[var(--glass-text-secondary)] shadow-[0_6px_18px_rgba(15,23,42,0.045)]">
      <div className="flex items-center gap-2">
        <AppIcon
