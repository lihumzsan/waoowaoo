...
export const WORKSPACE_CANVAS_NODE_DEFINITIONS = {
  ...
  bgmScore: {
    ...
    resource: supported('episodeData'),
    runtime: taskRuntime(),
    materializeFromTask: materializeFromTask('ProjectEpisode', TASK_TYPE.AUDIO_DESIGN_PLAN, TASK_TYPE.MUSIC_SCORE_GENERATE),
  ...
  ambientSound: {
    ...
    resource: supported('episodeData'),
    runtime: taskRuntime(),
    materializeFromTask: materializeFromTask('ProjectEpisode', TASK_TYPE.AUDIO_DESIGN_PLAN, TASK_TYPE.AMBIENT_SOUND_GENERATE),
