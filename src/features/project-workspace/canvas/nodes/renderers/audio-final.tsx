    ...
    details.sources.length > 0 ? (
      <div className="space-y-2">
        ...
        {details.sources.map((source) => (
          ...
          >
            <div className="min-w-0">
              <p className={`${SELECTABLE_TEXT_CLASS} break-words text-xs font-semibold text-[var(--glass-text-primary)]`}>
                {labels('sourceIndex', { index: source.sourceIndex })}
              </p>
            </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <p className={`${SELECTABLE_TEXT_CLASS} break-words text-xs font-semibold text-[var(--glass-text-primary)]`}>
                    {labels('sourceIndex', { index: section.sourceIndex })}
                  </p>
