              ...
              <div className="min-h-0 space-y-3 overflow-hidden">
                ...
                {activeShot ? (
                  <div className="space-y-3 rounded-lg border border-slate-200 bg-white p-4">
                    ...
                    <PromptBlock title={t('fields.description')} value={activeShot.visualAction} emptyText={t('empty.noPreviewShot')} clamp />
                    <button
                      type="button"
                      className="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-[var(--glass-text-secondary)] transition hover:bg-slate-50"
...
function PromptBlock({
  ...
  return (
    <section className="space-y-1.5 rounded-md bg-slate-50 p-3">
      ...
      <p className={`${clamp ? 'line-clamp-3' : 'whitespace-pre-wrap'} break-words text-sm leading-6 text-[var(--glass-text-secondary)]`}>
