...
const ROUTE_FILES = [
  ...
  'src/app/api/projects/[projectId]/edit-script/storyboard/coordinates/generate/route.ts',
  ...
  'src/app/api/user/coordinate-placement-test/analyze/route.ts',
  'src/app/api/user/coordinate-placement-test/generate/route.ts',
  'src/app/api/user/coordinate-placement-test/reference-views/route.ts',
