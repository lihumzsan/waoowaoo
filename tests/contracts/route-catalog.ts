...
export const ROUTE_FILES = [
  ...
  'src/app/api/asset-hub/operations/[operationId]/plan/route.ts',
  'src/app/api/asset-hub/picker/route.ts',
  'src/app/api/asset-hub/reference-to-character/extract/route.ts',
  ...
  'src/app/api/projects/[projectId]/reference-to-character/extract/route.ts',
