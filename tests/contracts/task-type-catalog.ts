...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.EDIT_SCRIPT_STORYBOARD_PREPARE]: 'tests/unit/worker/edit-script-storyboard-consistency.test.ts',
  ...
  [TASK_TYPE.BGM_SCORE_GENERATE]: 'tests/unit/worker/bgm-score-worker.test.ts',
  ...
  [TASK_TYPE.REGENERATE_STORYBOARD_TEXT]: 'tests/unit/worker/llm-proxy.test.ts',
  [TASK_TYPE.INSERT_PANEL]: 'tests/unit/worker/llm-proxy.test.ts',
  ...
  [TASK_TYPE.EDIT_CINEMATOGRAPHY_SHOT_PLAN_GENERATE]: 'tests/unit/worker/edit-script-structured-generate.test.ts',
