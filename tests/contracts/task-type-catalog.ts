...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.IMAGE_EPISODE_COVER]: 'tests/unit/worker/episode-cover-image.test.ts',
  ...
  [TASK_TYPE.VIDEO_SEAM_CONCAT]: 'tests/unit/worker/video-seam-concat.test.ts',
  [TASK_TYPE.ENVIRONMENT_SOUND_ANALYZE]: 'tests/unit/worker/environment-sound.test.ts',
  [TASK_TYPE.ENVIRONMENT_SOUND_GENERATE]: 'tests/unit/worker/environment-sound.test.ts',
  [TASK_TYPE.ENVIRONMENT_SOUND_CLEANUP]: 'tests/unit/worker/environment-sound.test.ts',
  [TASK_TYPE.LIP_SYNC]: 'tests/unit/worker/video-worker.test.ts',
  [TASK_TYPE.VOICE_LINE]: 'tests/unit/worker/voice-worker.test.ts',
  [TASK_TYPE.FREE_VOICE]: 'tests/unit/worker/voice-worker.test.ts',
  ...
  [TASK_TYPE.GENERATE_FIRST_LAST_FRAME_PROMPT]: 'tests/unit/worker/first-last-frame-prompt.test.ts',
