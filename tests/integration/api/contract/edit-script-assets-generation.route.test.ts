...
describe('edit script asset generation route confirmation contract', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('rejects a request whose plan confirmation was lost before the API boundary', async () => {
  ...
  it('forwards the real plan confirmation and quote to the unified operation adapter', async () => {
    const response = await POST(
      buildMockRequest({
        path: '/api/projects/project-1/edit-script/assets/generate',
        method: 'POST',
