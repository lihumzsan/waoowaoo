...
export const HISTORICAL_DEFECT_CATALOG = [
  {
    ...
    invariantIds: ['AR-01', 'AR-02', 'AR-03', 'AR-05'],
  ...
  },
  {
    ...
    rootCause: 'DB resources, Task terminal facts, stream runtime, timers, and refetch timing competed to hand off the final Canvas view.',
    severity: 'P0',
    module: 'canvas-node',
