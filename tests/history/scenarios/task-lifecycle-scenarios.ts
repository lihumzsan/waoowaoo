...
const absentRecoveryScenario: HistoricalRegressionScenario = {
  ...
  async execute(context) {
    ...
    const envelope = buildTaskJobEnvelope({
      ...
      operationSource: 'assistant', approvalGrantId: 'grant-1', operationExecutionId: 'execution-1',
      operationPlanTaskId: 'plan-task-1', operationRequestId: 'request-1', priority: 7,
    })
