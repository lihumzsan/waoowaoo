...
describe('edit script block-first prompt flow', () => {
  it('builds a unified primary prompt without intermediate specialist inputs', () => {
    ...
    expect(videoPromptBible).toContain('visualPromptPolicy')
    ...
    expect(videoPromptBible).toContain('优秀 styleReferenceInterpretation 示例')
    ...
    expect(videoPromptBible).toContain('对应的 visualPromptPolicy')
    ...
    expect(videoPromptBlock).toContain('videoPromptBible.visualPromptPolicy.positivePrompt')
    expect(videoPromptBlock).toContain('videoPromptBible.visualPromptPolicy.negativePrompt')
