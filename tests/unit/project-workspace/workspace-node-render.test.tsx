...
describe('workspace node rendering', () => {
  ...
  it('renders edit asset group thumbnails with the shared image loader and AppIcon placeholders', () => {
    ...
    const charactersHeadingIndex = html.indexOf('characters')
    const characterCardIndex = html.indexOf('Pilot')
    const locationsHeadingIndex = html.indexOf('locations')
    const locationCardIndex = html.indexOf('Dock')
    expect(charactersHeadingIndex).toBeGreaterThanOrEqual(0)
    expect(characterCardIndex).toBeGreaterThan(charactersHeadingIndex)
    expect(locationsHeadingIndex).toBeGreaterThan(characterCardIndex)
    expect(locationCardIndex).toBeGreaterThan(locationsHeadingIndex)
