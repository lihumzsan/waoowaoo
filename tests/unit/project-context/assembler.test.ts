      ...
      .mockResolvedValueOnce([
        {
          ...
          approvalGrantId: 'grant-active-1',
          operationExecutionId: 'execution-active-1',
          operationPlanTaskId: 'plan-task-active-1',
      ...
      .mockResolvedValueOnce([
        {
          ...
          approvalGrantId: 'grant-recent-1',
          operationExecutionId: 'execution-recent-1',
          operationPlanTaskId: 'plan-task-recent-1',
