...
<p align="center">
  面向 AI 视频生产的自托管创作工作区：支持影视故事与商业广告，从内容脚本出发完成创意方向、视觉资产、视频分段与声音设计。
</p>
...
- **商业广告制作**：从可验证的商业 Brief 形成定时商业脚本，并沿用同一套方向、资产、视频与声音生产能力。
...
6. 创建项目时选择 **影视故事** 或 **商业广告**，然后开始第一轮制作。项目类型创建后不可更改，以避免专业文档和生产状态串线。
